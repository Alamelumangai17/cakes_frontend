...
const RegisterScreen = ({ navigation }) => {
    ...
    const handleRegistration = async (values) => {
        ...
        try {
            const response = await axios.post('http://192.168.209.14:1503/register', formData);
    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <ImageBackground 
                source={require('../../assets/logo5.jpeg')} // Make sure the path is correct
                style={styles.container}
                resizeMode="cover"
            >
                <Text style={styles.title}>WELCOME TO DREAMY DESSERT’S </Text>
...
const styles = StyleSheet.create({
    ...
    input: {
        ...
        color: '#8a6408', // White text for input
    },
    inputError: {
        borderColor: 'red',
    },
    ...
    dateButton: {
        backgroundColor: '#8a6408', // Match button color with AdminLoginScreen
        padding: 15,
        borderRadius: 10,
        alignItems: 'center',
        marginBottom: 10,
