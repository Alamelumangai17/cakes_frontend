...
const Payment = ({ navigation }) => {
  ...
  const handlePay = () => {
    alert(`Your payment has received,thanks for shopping`);
    navigation.navigate('HomeScreen');
  };

  return (
    // <ImageBackground
    //   source={require('../../assets/b.jpeg')} // Replace with your actual image path
