...
const LoginScreen = ({ navigation }) => {
  ...
  const handleLogin = async (values) => {
    ...
    try {
      const response = await axios.post('http://192.168.209.14:1503/login', values);
  ...
  return (
    <ImageBackground
      source={require('../../assets/logo5.jpeg')} // Background image
      style={styles.backgroundImage}
    >
      <View style={styles.overlay} />
      <View style={styles.container}>
        <Text style={styles.title}>Welcome Back to Dreamy Dessert</Text>
