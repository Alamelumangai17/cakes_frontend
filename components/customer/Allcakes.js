...
const ModelPage = ({ navigation }) => {
  const [modelItems, setModelItems] = useState([
    { id: '1', name: 'Roses with Teddy', price: 30, image: require('../../assets/pas.jpeg') },
    { id: '2', name: 'Redwelvet', price: 70, image: require('../../assets/as.jpeg') },
    { id: '3', name: 'whiteforest', price: 60, image: require('../../assets/ass.jpeg') },
    { id: '4', name: 'Cupcakes', price: 40, image: require('../../assets/ai.jpeg') },
    { id: '5', name: 'Cupcakes', price: 30, image: require('../../assets/inn.jpeg') },
  ]);
  ...
  return (
    ...
    // >
      <View style={styles.container}>
        <Text style={styles.title}>Piece Cakes</Text>
        <ScrollView>
          {modelItems.map((item) => (
