...
const ModelPage = ({ navigation }) => {
  const [modelItems, setModelItems] = useState([
    { id: '1', name: 'Roses with Teddy', price: 50, image: require('../../assets/do1.jpeg') },
    { id: '2', name: 'Redwelvet', price: 7000, image: require('../../assets/d2.jpeg') },
    { id: '3', name: 'whiteforest', price: 6000, image: require('../../assets/d3.jpeg') },
    { id: '4', name: 'Cupcakes', price: 4000, image: require('../../assets/d4.jpeg') },
    { id: '5', name: 'Cupcakes', price: 4000, image: require('../../assets/d5.jpeg') },
  ]);
